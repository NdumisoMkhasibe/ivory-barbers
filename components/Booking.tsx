  ...
  return <section id="book" className="booking-section" aria-labelledby="book-title">
    ...
    <div className="booking-shell">
      {confirmation ? <div className="booking-confirmation">
        ...
        <button className="booking-text-button" type="button" onClick={resetBooking}>Make another demo booking</button>
      </div> : <>
        ...
        <div className="booking-layout"><div className="booking-main">
          ...
          {step === 4 && <>
            ...
            <div className="booking-actions"><button className="booking-text-button" type="button" disabled={submitting} onClick={() => goTo(3)}>Back</button><button className="booking-button" type="button" disabled={!consent || submitting} onClick={saveBooking}>{submitting ? <><span className="booking-spinner" /> Saving appointment…</> : <>Confirm demo booking</>}</button></div>
          </>}
